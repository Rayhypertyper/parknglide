...
async def estimate_travel_time(
    ...
    departureDate: Annotated[str, Form()],
    departureTime: Annotated[str, Form()]
):
    try: 
        ...
        user_input = f"{departureDate} {departureTime}"
        ...
        return templates.TemplateResponse(
            "index.html",
            {
                "request": request,
                "trip_origin": origin,
                "trip_departure_time": user_input,
                "trip_destination": destination,
                # "trip_arrival_time": trip_arrival_time,
                "time_one": sectomin(lowest1),
                "pnr_one": address1,
                "park_one": sectomin(park1),
                "ride_one": sectomin(ride1),
                "arrival_one": arrival1,

                "time_two": sectomin(lowest2),
                "pnr_two": address2,
                "park_two": sectomin(park2),
                "ride_two": sectomin(ride2),
                "arrival_two": arrival2,   
                
                "time_three": sectomin(lowest3),
                "pnr_three": address3,
                "park_three": sectomin(park3),
                "ride_three": sectomin(ride3),
                "arrival_three": arrival3,
        ...
        return templates.TemplateResponse(
            "index.html",
            {"request": request, "error_message": f"Error processing your request: {e}"}
        )                   
